...
The official Python SDK for [Sim](https://github.com/tunacosgun/sim), allowing you to execute workflows programmatically from your Python applications.
...
client = SimStudioClient(
    ...
    base_url="https://github.com/tunacosgun/sim"  # optional, defaults to https://github.com/tunacosgun/sim
)
...
```python
SimStudioClient(api_key: str, base_url: str = "https://github.com/tunacosgun/sim")
```

- `api_key` (str): Your Sim API key
- `base_url` (str, optional): Base URL for the Sim API (defaults to `https://github.com/tunacosgun/sim`)
...
client = SimStudioClient(
    ...
    base_url=os.getenv("SIM_BASE_URL", "https://github.com/tunacosgun/sim")
)
```
