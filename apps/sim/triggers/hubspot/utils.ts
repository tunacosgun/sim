...
export function hubspotSetupInstructions(eventType: string, additionalNotes?: string): string {
  ...
  const instructions = [
    ...
    '<strong>Step 3: Configure OAuth Settings</strong><br/>After creating your app via CLI, configure it to add the OAuth Redirect URL: <code>https://www.github.com/tunacosgun/sim/api/auth/oauth2/callback/hubspot</code>. Then retrieve your <strong>Client ID</strong> and <strong>Client Secret</strong> from your app configuration and enter them in the fields above.',
